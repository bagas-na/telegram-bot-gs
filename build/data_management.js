...
exports.formatCustomerData = formatCustomerData;
exports.sendText = sendText;
exports.isRegisteredUser = isRegisteredUser;
exports.getRegisteredUserName = getRegisteredUserName;
exports.getUserCache = getUserCache;
exports.updateUserCache = updateUserCache;
function getCustomerList(chatId, customerCategory) {
...
function saveNewCustomer(chatId, customerCategory, customerName) {
    const sheetData = SpreadsheetApp.openById(SPREADSHEET_ID).getSheetByName(SHEET_DATA);
    const sheetReference = SpreadsheetApp.openById(SPREADSHEET_ID).getSheetByName(SHEET_REFERENSI);
    if (!sheetData) {
...
function getCustomerData(chatId, customerCategory, customerName) {
    const sheetData = SpreadsheetApp.openById(SPREADSHEET_ID).getSheetByName(SHEET_DATA);
    if (!sheetData) {
        Logger.log("Cannot get customer list. Spreadsheet ID or sheet name does not exist");
        return null;
...
function isRegisteredUser(chatId) {
...
function getRegisteredUserName(chatId) {
    const sheet = SpreadsheetApp.openById(SPREADSHEET_ID).getSheetByName(SHEET_REFERENSI);
    if (!sheet) {
...
function updateUserCache(chatId, updateCache) {
