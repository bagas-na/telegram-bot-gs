...
export function formatPropertySelectionMenuHTML(customerCategory: CustomerCategory): string {
  let formatText;
  formatText = "➡️ <strong>Silahkan pilih informasi GC yang ingin di diubah</strong>\n";
  formatText += "Langsung klik saja pada tombol yang muncul di bawah!\n\n";
  formatText += "▶️ <strong>submit_proposal</strong>, apakah proposal masif telah dikirimkan.\n";
  formatText += "▶️ <strong>connectivity</strong>, status funneling layanan Datin/WMS/Indibiz/etc.\n";
  formatText += "▶️ <strong>eazy</strong>, status funneling Antares Eazy.\n";
  formatText += "▶️ <strong>oca</strong>, status funneling OCA.\n";
  formatText += "▶️ <strong>digiclinic</strong>, status funenling Digiclinic.\n";
  formatText += "▶️ <strong>pijar</strong>, status funneling ekosistem Pijar.\n";
  formatText += "▶️ <strong>sprinthink</strong>, status funneling Sprinthink.\n";
  formatText += "▶️ <strong>nilai_project</strong>, estimasi nilai project.\n";
  formatText += `▶️ <strong>CANCEL</strong>, kembali ke daftar pelanggan untuk kategori ${customerCategory}.`;
